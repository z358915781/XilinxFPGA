// -------------------------------------------------------------
// 
// File Name: D:\AverFilter8192P_b18_V1\AverFilter8192P_b18_V1.v
// Created: 2022-05-26 10:42:36
// 
...
// Source Path: AverFilter8192P_b18_V1/AverFilter8192P_b18_V1
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module AverFilter8192P_b18_V1
  ...
  wire CT70_out1;
  wire Or2_out1;
  wire [12:0] Switch83_out1;  // ufix13
  reg [12:0] Unit_Delay32_out1;  // ufix13
  wire [12:0] Add11_out1;  // ufix13
  wire Ro10_relop1;
  ...
  wire [18:0] Bit_Slice6_out1;  // ufix19
  ...
  assign Switch83_out1 = (Switch208_out1 == 1'b0 ? 13'b0000000000000 :
              13'b0000000000001);
  ...
  always @(posedge g_clk)
    begin : Unit_Delay32_process
      if (Rst_n == 1'b0) begin
        Unit_Delay32_out1 <= 13'b0000000000000;
      end
      else begin
  ...
  assign Add12_out1 = Add11_out1 + 13'b0000000000001;



  SimpDualPortRAM_Wrapper_generic   #  (.AddrWidth(13),
                                        .DataWidth(18)
                                        )
  ...
  assign Bit_Slice6_out1 = Unit_Delay30_out1[31:13];



  assign Data_Type_S11_out1 = $signed(Bit_Slice6_out1[17:0]);



  assign Filter_Out0_b18 = Data_Type_S11_out1;

endmodule  // AverFilter8192P_b18_V1
