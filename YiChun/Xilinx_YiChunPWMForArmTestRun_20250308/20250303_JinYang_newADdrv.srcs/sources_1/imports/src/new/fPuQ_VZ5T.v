// -------------------------------------------------------------
// 
// File Name: D:\FPGA_MZ\fPuQ_VZ5T\fPuQ_VZ5T.v
// Created: 2025-02-10 15:06:46
// 
...
// 
// Module: fPuQ_VZ5T
// Source Path: fPuQ_VZ5T/fPuQ_VZ5T
// Hierarchy Level: 0
// Model version: 15.2
// 
// -------------------------------------------------------------
...
module fPuQ_VZ5T
  ...
  input   signed [15:0] UQlmt_s16;  // int16
  ...
  input   signed [15:0] dWin_s16;  // int16
  input   signed [15:0] dWS1in_s16;  // int16
  ...
  output  signed [15:0] dWout_s16;  // int16
  output  signed [15:0] dWDead_s16;  // int16
  output  signed [15:0] dWoutAbs_s16;  // int16
  output  signed [15:0] dW2_s16;  // int16
  output  signed [15:0] dWS1out_s16;  // int16
  ...
  wire RO6_relop1;
  wire signed [21:0] UQlmt_s16_dtc;  // sfix22
  wire signed [21:0] Switch41_out1_4;  // sfix22
  wire signed [16:0] Unary_Minus1_in0;  // sfix17
  ...
  wire signed [18:0] Switch41_out1_5;  // sfix19
  wire signed [15:0] Unary_Minus1_out1_1;  // int16
  wire signed [18:0] RO11_1_1;  // sfix19
  wire RO11_relop1;
  wire signed [18:0] Unary_Minus1_out1_dtc_1;  // sfix19
  wire signed [18:0] Switch1_out1_6;  // sfix19
  wire signed [15:0] S16_9_out1;  // int16
  ...
  assign op15_relop1 = dWin_s16 < Unary_Minus2_out1;


  assign switch_compare_1_6 = op15_relop1 > 1'b0;



  assign op14_relop1 = dWin_s16 > Inrdb_s16;


  assign switch_compare_1_7 = op14_relop1 > 1'b0;



  assign Add16_14_out1 = Unary_Minus2_out1 - dWin_s16;


  assign Switch10_out1 = (switch_compare_1_6 == 1'b0 ? 16'sb0000000000000000 :
              Add16_14_out1);


  assign Add16_13_out1 = Inrdb_s16 - dWin_s16;


  assign Switch9_out1 = (switch_compare_1_7 == 1'b0 ? Switch10_out1 :
              Add16_13_out1);
  ...
  assign switch_compare_1_8 = op4_relop1 > 1'b0;
  ...
  assign switch_compare_1_9 = op3_relop1 > 1'b0;
  ...
  assign Switch2_out1 = (switch_compare_1_8 == 1'b0 ? C16_2_out1_dtc :
              Add16_7_out1);
  ...
  assign Switch1_out1 = (switch_compare_1_9 == 1'b0 ? Switch2_out1 :
              Add16_6_out1);
  ...
  assign switch_compare_1_10 = op2_relop1 > 1'b0;
  ...
  assign switch_compare_1_11 = op1_relop1 > 1'b0;
  ...
  assign Switch5_out1 = (switch_compare_1_10 == 1'b0 ? 16'sb0000000000000000 :
              Add16_2_out1);
  ...
  assign Switch3_out1 = (switch_compare_1_11 == 1'b0 ? Switch5_out1 :
              Add16_1_out1);
  ...
  assign RO63_1_1 = {{9{PDisLmt1_s16[15]}}, PDisLmt1_s16};
  assign RO63_relop1 = S22_3_out1 > RO63_1_1;
  ...
  assign Switch41_out1 = (RO63_relop1 == 1'b0 ? S22_3_out1 :
              PDisLmt1_s16_dtc);


  assign RO13_1_1 = {{9{PChgLmt1_s16[15]}}, PChgLmt1_s16};
  assign RO13_relop1 = Switch41_out1 < RO13_1_1;
  ...
  assign RO64_1_1 = {{9{PDisLmt2_s16[15]}}, PDisLmt2_s16};
  assign RO64_relop1 = S22_1_out1 > RO64_1_1;
  ...
  assign Switch41_out1_1 = (RO64_relop1 == 1'b0 ? S22_1_out1 :
              PDisLmt2_s16_dtc);


  assign RO14_1_1 = {{9{PChgLmt2_s16[15]}}, PChgLmt2_s16};
  ...
  assign RO65_1_1 = {{6{PDisLmtInr_s16[15]}}, PDisLmtInr_s16};
  assign RO65_relop1 = S22_2_out1 > RO65_1_1;
  ...
  assign Switch41_out1_2 = (RO65_relop1 == 1'b0 ? S22_2_out1 :
              PDisLmtInr_s16_dtc);


  assign RO15_1_1 = {{6{PChgLmtInr_s16[15]}}, PChgLmtInr_s16};
  ...
  assign RO62_1_1 = {{4{PacdisLmt_s16[15]}}, PacdisLmt_s16};
  assign RO62_relop1 = Add20_3_out1 > RO62_1_1;
  ...
  assign Switch41_out1_3 = (RO62_relop1 == 1'b0 ? Add20_3_out1 :
              PacdisLmt_s16_dtc);


  assign RO12_1_1 = {{4{PacChgLmt_s16[15]}}, PacChgLmt_s16};
  assign RO12_relop1 = Switch41_out1_3 < RO12_1_1;
  ...
  assign Switch1_out1_4 = (RO12_relop1 == 1'b0 ? Switch41_out1_3 :
              PacChgLmt_s16_dtc);
  ...
  assign RO6_1_1 = {{6{UQlmt_s16[15]}}, UQlmt_s16};
  assign RO6_relop1 = S22_4_out1 > RO6_1_1;


  assign UQlmt_s16_dtc = {{6{UQlmt_s16[15]}}, UQlmt_s16};
  ...
  assign Unary_Minus1_in0 =  - ({UQlmt_s16[15], UQlmt_s16});
  assign Unary_Minus1_out1 = Unary_Minus1_in0[15:0];


  assign RO1_1_1 = {{6{Unary_Minus1_out1[15]}}, Unary_Minus1_out1};
  assign RO1_relop1 = Switch41_out1_4 < RO1_1_1;


  assign Unary_Minus1_out1_dtc = {{6{Unary_Minus1_out1[15]}}, Unary_Minus1_out1};
  ...
  assign S16_8_out1 = Add17_1_out1[15:0];
  ...
  assign switch_compare_1_12 = InrfdwSel > 1'b0;



  assign op5_relop1 = dWS1in_s16 > 16'sb0000000000000000;


  assign op7_relop1 = dWS1in_s16 < 16'sb0000000000000000;
  ...
  assign switch_compare_1_13 = op11_out1 > 1'b0;
  ...
  assign Switch4_out1 = (switch_compare_1_13 == 1'b0 ? C16_5_out1_dtc :
              dWS1in_s16);


  assign Switch6_out1 = (switch_compare_1_12 == 1'b0 ? dWS1in_s16 :
              Switch4_out1);


  assign dWout_s16 = Switch6_out1;

  assign dWDead_s16 = Switch9_out1;

  assign Abs_y = (Switch6_out1 < 16'sb0000000000000000 ?  - ({Switch6_out1[15], Switch6_out1}) :
              {Switch6_out1[15], Switch6_out1});
  assign Abs_out1 = Abs_y[15:0];


  assign dWoutAbs_s16 = Abs_out1;

  assign dW2_s16 = Switch1_out1;
  ...
  assign Switch41_out1_5 = (RO61_relop1 == 1'b0 ? Dly_1_out1 :
              C16_8_out1_dtc);


  assign Unary_Minus1_out1_1 = 16'sb1000101011010000;


  assign RO11_1_1 = {{3{Unary_Minus1_out1_1[15]}}, Unary_Minus1_out1_1};
  assign RO11_relop1 = Switch41_out1_5 < RO11_1_1;


  assign Unary_Minus1_out1_dtc_1 = {{3{Unary_Minus1_out1_1[15]}}, Unary_Minus1_out1_1};
  ...
  assign S16_9_out1 = Switch1_out1_6[15:0];


  assign dWS1out_s16 = S16_9_out1;
